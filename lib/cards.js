...
// Immatriculation normalisée : majuscules, sans espace, tiret ni point
// ("ab-243 rq.01" -> "AB243RQ01"). Appliquée à l'enregistrement pour que
// la recherche, l'unicité et l'impression des cartes soient cohérentes.
export function normaliserImmatriculation(v) {
